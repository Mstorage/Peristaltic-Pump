...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM1_MspPostInit 0 */
    ...
    */
    ...
    HAL_GPIO_Init(Motor_PWMstep_GPIO_Port, &GPIO_InitStruct);
...
/**
  ...
  * @param  PSC_Speed：生成PWM波的TIM1的预分频值;
  * @retval none;
  */
void Motor_PWM_Output_Init(uint8_t PSC_Speed) {
     ...
     if (HAL_TIM_Base_Init(&htim1) != HAL_OK)
  {
    ...
    // 配置 TIM1 CH1 通道为 PWM 模式
    sConfig.OCMode = TIM_OCMODE_PWM1;
    sConfig.Pulse = 3600; // 初始占空比 50%
...
/**
  * @brief  将MotorStep引脚设置为普通的GPIO输出
  * @param  none;
  * @retval none;
  */
